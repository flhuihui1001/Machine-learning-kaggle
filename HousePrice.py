...
SEED = 0
NROWS = None
SUBMISSION_FILE = '/Users/lingyaomeng/Desktop/ML/HousePrice/input/sample_submission.csv'


## Load the data ##
train = pd.read_csv("/Users/lingyaomeng/Desktop/ML/HousePrice/input/train.csv")
test = pd.read_csv("/Users/lingyaomeng/Desktop/ML/HousePrice/input/test.csv")
...
all_data['All_Liv_SF'] = np.log1p(all_data['1stFlr_2ndFlr_Sf'] + all_data['LowQualFinSF'] + all_data['GrLivArea'])
